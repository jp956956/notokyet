<template>
  <b-container>
    <b-row class="pt-5" style="position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);width:60%">
      <b-col>
